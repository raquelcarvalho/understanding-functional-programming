...
describe("Functional Programming Workshop", function () {
  ...
  describe("Map", function () {
    ...
    it("returns the array of the grades", function () {
      ...
      var byGrade = (student) => student.grade;

      var grades = students.map(byGrade);
    ...
    it("returns the array of the names", function () {
      ...
      var byName = (value) => value.name;

      var byNames = (values) => values.map(byName);
  ...
  describe("Filter", function () {
    ...
    it("returns the students with the grade bigger than or equal to 6", function () {
      ...
      var gradeBiggerThan = (student) => student.grade >= 6;

      var filterApprovedStudents = students.filter(gradeBiggerThan);
  ...
  describe("Map + Filter", function () {
    it("returns the names of the students with the grade bigger than or equal to 6", function () {
      ...
      var gradeBiggerThan = (student) => student.grade >= 6;
      var byName = (student) => student.name;

      var filterApprovedStudentsByName = students
        .filter(gradeBiggerThan)
        .map(byName);
  ...
  describe("Reduce", function () {
    ...
    it("returns the combined names", function () {
      ...
      var combinedNamesFunc = (acc, current) => acc + current.name;

      var combinedNames = students.reduce(combinedNamesFunc, "");
    ...
    it("returns the even numbers", function () {
      ...
      var returnOnlyEvens = (acc, current) => {
        if (current % 2 === 0) {
          acc.push(current);
        }
      ...
      var evenNumbers = numbers.reduce(returnOnlyEvens, []);
  ...
  describe("Map + Reduce", function () {
    it("returns the total sum of the grades", function () {
      ...
      var sumTotalGrades = (acc, current) => acc + current;

      var totalSumOfTheGrades = students
        .map((item) => item.grade)
        .reduce(sumTotalGrades, 0);
  ...
  describe("Compose", function () {
    it("returns the capitalized to upper case string", function () {
      //!Compose tem em qualquer lib e a estrutura dela é essa
    ...
    it('returns the "angry" string', function () {
      ...
      var toUpperCase = (value) => value.toUpperCase();

      var exclaim = (value) => `${value}!!!`;
    ...
    it("returns the number of words", function () {
      ...
      var splitPhrase = (phrase) => phrase.split(" ");

      var countWord = (words) => words.length;

      var numberOfWords = compose(countWord, splitPhrase);
    ...
    it('returns the "angry" reversed string', function () {
      ...
      var toUpperCase = (value) => value.toUpperCase();
      var exclaim = (value) => `${value}!!!`;
      var reverse = (value) => value.split("").reverse().join("");
